...
public class SimpleRatingBar extends View {
    ...
    private CharSequence[] bottomArray;
    ...
    private void initView() {
        ...
        paintTextBottom = new Paint(Paint.ANTI_ALIAS_FLAG);
        paintTextBottom.setColor(bottomTextColor);
        paintTextBottom.setTextSize(textSize);
    ...
    private void parseAttrs(AttributeSet attrs) {
        ...
        bottomTextColor = arr.getColor(R.styleable.SimpleRatingBar_srb_bottomTextColor, Color.GRAY);
        ...
        textPadding = arr.getDimensionPixelSize(R.styleable.SimpleRatingBar_srb_bottomTextPadding, SizeUtils.dp2px(12));
        textSize = arr.getDimensionPixelSize(R.styleable.SimpleRatingBar_android_textSize, SizeUtils.sp2px(12));
        starsSeparation = arr.getDimensionPixelSize(R.styleable.SimpleRatingBar_srb_starsSeparation, SizeUtils.dp2px(4));
        ...
        bottomArray = arr.getTextArray(R.styleable.SimpleRatingBar_android_entries);
        if (null == bottomArray) {
            bottomArray = new CharSequence[0];
        }
    ...
    private void performStarSizeAssociatedCalculations(int width, int height) {
        ...
        float startingX = ((width - getPaddingLeft() - getPaddingRight()) >> 1) - totalStarsWidth / 2 + getPaddingLeft();
        float startingY = ((height - getPaddingTop() - getPaddingBottom()) >> 1) - totalStarsHeight / 2 + getPaddingTop();
    ...
    private void drawText(Canvas canvas, float x, float y, String text) {
        ...
        float half = currentStarSize / 2;

        if (null == textRect) {
            textRect = new Rect();
        }

        paintTextBottom.getTextBounds(text, 0, text.length(), textRect);

        int textHalf = (textRect.right - textRect.left) / 2;

        int textX = (int) (x + half - textHalf);
        int textY = (int) (y + currentStarSize + textPadding);

        canvas.drawText(text, textX, textY, paintTextBottom);
    }
    ...
    public void setBottomArray(String[] bottomArray) {
    ...
    public void setBottomArray(int bottomArr) {
        setBottomArray(getResources().getStringArray(bottomArr));
    }
