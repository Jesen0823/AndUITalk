...
/**
 * PolyToPolyViewShadowLinearLayout 升级版 微调以适应滑动DrawerLayout:
 * 缩放后仍然是以(0,0)为原点布局的，需要将整个布局向右移动 mWidth*(1-mFactor)
 * */
class PolyToPolyViewShadowLinearLayout2 @JvmOverloads constructor(
    ...
    private fun updateFold() {
        ...
        // 整体移动距离
        val transWidth = mWidth * (1 - mFactor)
